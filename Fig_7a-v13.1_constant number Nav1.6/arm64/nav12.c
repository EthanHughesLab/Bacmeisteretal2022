...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "na_ion");
 	...
 	ivoc_help("help ?1 na12 /Volumes/Internodes/Fig.4_NEURON for paper/121120/Fig_7a-v13.1_constant number Nav1.6/nav12.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 87 in file nav12.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Volumes/Internodes/Fig.4_NEURON for paper/121120/Fig_7a-v13.1_constant number Nav1.6/nav12.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "na12.mod\n"
